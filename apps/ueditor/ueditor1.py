...
uedit_bp = Blueprint('ueditor',__name__,url_prefix='/ueditor')
...
@uedit_bp.before_app_first_request
...
@uedit_bp.route('/upload/',methods=['GET','POST'])
def upload():
    action = request.args.get('action')
    result = {}
    if action == 'config':
        config_path = os.path.join(uedit_bp.static_folder or app.static_folder,'ueditor','config.json')
